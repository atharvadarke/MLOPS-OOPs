# MLOPS-OOPs
 1. class and object
 2. class has data/attributes and functions/methods
 3. why python is called OOPs based? -> Everything in python is an object of a particular class
 4. Avantages of OOPs:-
    >Code reusability
    >Easy debugging
...
5. Completed Project(Chatbook class)
    -function v/s method
